    ...
    <div class="row column">
      <div class="grid-x">
        ...
        <div class="cell small-12 medium-6 small-order-1 medium-order-2">
          <nav class="legalNav">
            <ul class="legalMenu">
              ...
              <?php 
                if( is_front_page())
                  echo "<li><a href='wp-content/uploads/2020/07/Form-CRS-June-2020.pdf'>Form CRS</a></li>";
              ?>
        ...
        <div class="cell small-12 medium-6 medium-order-1 small-order-2">
			<p style="<?= (is_front_page() ? 'color: #b2ad96;' : '') ?>">&copy; Brandywine Oak Private Wealth <?= date('Y') ?>. <a href="https://brandywineoak.com/homepage/">All</a> rights reserved.</p>
        </div>
      </div>
    </div>
	</footer>
